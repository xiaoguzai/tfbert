...
class  Bert(tf.keras.layers.Layer):
    ...
    def build(self, input_ids):
        ...
        #做数学题的内容中vocab_size = self.vocab_size = 21128,
        #embedding_size = 768
        self.encoder_layer = []
    ...
    def call(self,input_ids):
        ...
        #output_embeddings = [<'bert/embeddings/dropout/Identity:0',shape = 
        #(None,None,1024)>,<tf.Tensor 'Placeholder_1:0' shape = (None,None)]
...
class  Embeddings(tf.keras.layers.Layer):
    ...
    def call(self,inputs):
        ...
        shape = input_ids.get_shape().as_list()
        maxlen = shape[1]
        batch_size = shape[0]
...
class  Transformer(tf.keras.layers.Layer):
    ...
    def call(self,inputs,**kwargs):
        ...
        #inputs = ['<bert/embeddings/dropout/Identity:0',shape=(None,None,1024)>
        #<tf.Tensor 'Placeholder_1:0',shape=(None,None)]
        residual = inputs[0]
        ...
        #embedding_output = Tensor("bert/transformer_0/dense0/BiasAdd:0",
        #shape=(None,None,768)
